...
import { contactApi } from 'redux/rtk/rtk.api';
...
export const contactsSlice = createSlice({
  ...
  reducers: {
    ...
    setIsOpenToWork: (state, action) => {
      state.isOpenToWork = action.payload;
    },
    [contactApi.reducerPath]: contactApi.reducer,
  },
});
//------робота з АРІ через санки б має бути в слайсі
// extraReducers: {
...
// ----робота з локальним стейтом має бути в слайсі
// reducers: {
